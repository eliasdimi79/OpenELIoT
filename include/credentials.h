 ...
 */
const char FALLBACK_TB_DEVICE_TOKEN[] = "HoAyblF65pV5XaiA7vh"; //TEST:HoAyblF65pV5XaiA7vh,GORGANADES:dAnDyfqIcxRhj1AHgaBT,TSIM #74:MOgtAza1eRHVnPaQ7Kin

/**
 * Fallback cellular provider APN. Used when not set in DeviceConfig
 */
const char FALLBACK_CELL_APN[] = "iot.1nce.net";
...
const char HTTP_TIME_SYNC_URL[] = "http://parnassos.exm.gr:1880/api/ts";
